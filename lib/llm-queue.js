...
class PriorityQueue {
    ...
    initEndpoints() {
        // Default to fleet hostnames; override with OLLAMA_NODES=http://host1:11434,http://host2:11434
        const FLEET_NODES = [
    ...
    async process() {
        ...
        // Allow CRITICAL/HIGH tasks to bypass normal concurrency limit by 1 to prevent stalling
